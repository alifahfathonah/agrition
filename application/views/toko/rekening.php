			...
			<tbody>
				...
				foreach ($rekening as $r) {
					...
					<tr>
						...
						<td><?= $r->no_rek ?></td>
						<td>
							<a class="btn btn-info" href="<?= base_url('toko/rekening/edit/'.$r->id_rekening); ?>"><i class="fa fa-edit"> Edit</i></a>
							<a class="btn btn-danger" href="<?= base_url('toko/rekening/hapus/'.$r->id_rekening); ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?');"><i class="fa fa-trash"> Hapus</i></a>
						</div>
					</td>
				</tr>
				<?php
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">
					<form action="<?= base_url('toko/rekening/tambah')?>" method="post">
